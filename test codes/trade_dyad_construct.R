...
Trade_dyads_i<-Trade_dyads[Trade_dyads$year==1995,]
...
Trade_dyads_abc_trades$Year[Trade_dyads_abc_trades$Year==1995]<-1
...
cov_ergm1$covar[cov_ergm1$covar==1995]<-1
...
set.vertex.attribute(net_adjmat,"covar", cov_ergm1$covar)
